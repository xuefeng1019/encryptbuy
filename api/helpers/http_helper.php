...
class HTTPHException extends Exception {
}

/**
 * An exception that gets thrown when there is an HTTP error (404, 500, etc.)
 */
class HTTPErrorException extends HTTPHException {
...
class HTTPInvalidUrlException extends HTTPHException {
...
class HTTPNoResponseException extends HTTPHException {
  public function __construct($url) {
...
class HTTPNoDataException extends HTTPHException {
...
class HTTPTooManyRedirsException extends HTTPHException {
  public function __construct($url) {
...
function redirect2($path, $permanent_redirect = FALSE, $host = '')
{
