...
class Avatar{
	...
	function uc_avatar($uid, $type = 'virtual', $returnhtml = 1) {
		...
		$uc_avatarflash = UC_API.'/camera.swf?inajax=1&appid=1&input='.$uc_input.'&agent='.md5($_SERVER['HTTP_USER_AGENT']).'&ucapi='.urlencode('http://www.wolonge.com/third_party/ucflash/').'&avatartype='.$type;
		if($returnhtml) {
			return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="407" height="477" id="mycamera" align="middle">
				...
				<embed src="'.$uc_avatarflash.'" quality="high" bgcolor="#ffffff" width="407" height="477" name="mycamera" align="middle" allowScriptAccess="always" allowFullScreen="false" scale="exactfit"  wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>';
		} else {
			return array(
				'width', '407',
	...
	function avatar_show($uid, $size='small', $returnsrc = FALSE) {
		...
		return '<img src="http://cdn.wolonge.com/upload/'.$uid.'.jpg" onerror="this.onerror=null;this.src=\'http://cdn.wolonge.com/upload/'.$uid.'.jpg">';
	}
